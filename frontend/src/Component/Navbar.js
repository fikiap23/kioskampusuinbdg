...
const Navbar = ({
  ...
  const handleSearchChange = (event) => {
    ...
    if (query) {
      fetch(
        `https://kioskampusuinbdg-sigma.vercel.app/api/products/search/${query}`
      )
        .then((res) => res.json())
            ...
            <MenuItems className="absolute right-0 z-50 mt-10 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              <MenuItem>
                <button
                  ...
                  className="w-full text-left rounded-t-md block px-4 py-2 text-xs text-gray-700 hover:bg-gray-100"
                >
                  All Category
                </button>
              </MenuItem>
              <MenuItem>
                <button
                  onClick={() => handleCategoryClick('Books and Stationary')}
                  className="w-full text-left block px-4 py-2 text-xs text-gray-700 hover:bg-gray-100"
                >
              ...
              <MenuItem>
                <button
                  onClick={() =>
                    handleCategoryClick('Clothing and Accessories')
                  }
                  className="w-full text-left block px-4 py-2 text-xs text-gray-700 hover:bg-gray-100"
                >
              ...
              <MenuItem>
                <button
                  onClick={() => handleCategoryClick('Foods and Beverages')}
                  className="w-full text-left block px-4 py-2 text-xs text-gray-700 hover:bg-gray-100"
                >
                  Foods and Beverages
                </button>
              ...
              <MenuItem>
                <button
                  ...
                  className="w-full text-left rounded-b-md block px-4 py-2 text-xs text-gray-700 hover:bg-gray-100"
                >
                  Other
                </button>
              </MenuItem>
