...
const AddProduct = () => {
  ...
  const handleSubmit = (event) => {
    ...
    fetch('https://kioskampusuinbdg-sigma.vercel.app/api/product', {
      method: 'POST',
      body: productData,
    })
      .then((response) => {
          ...
          <div className="flex flex-wrap justify-around">
            <div>
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                <MenuItems
                  transition
                  className="absolute right-0 z-99 mt-10 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 transition focus:outline-none"
                >
                  <MenuItem>
                    <button
                      onClick={() => setCategory('Books and Stationary')}
                      className="w-full text-left rounded-t-md block px-4 py-1 text-xs text-gray-700"
                    >
                  ...
                  <MenuItem>
                    <button
                      onClick={() => setCategory('Clothing and Accessories')}
                      className="w-full text-left block px-4 py-1 text-xs text-gray-700"
                    >
                  ...
                  <MenuItem>
                    <button
                      onClick={() => setCategory('Foods and Beverages')}
                      className="w-full text-left block px-4 py-1 text-xs text-gray-700"
                    >
                      Foods and Beverages
                    </button>
                  ...
                  <MenuItem>
                    <button
                      ...
                      className="w-full text-left rounded-b-md block px-4 py-1 text-xs text-gray-700"
                    >
                      Other
                    </button>
                  </MenuItem>
